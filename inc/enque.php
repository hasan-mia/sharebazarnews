...
function sharebazarnews_frontend_enque() {
   ...
   wp_enqueue_style( 'font_li_hasan_css', get_template_directory_uri() . '/fonts/li_hasan.css',false,'1.0','all');
   wp_enqueue_style( 'font_SolaimanLipi_css', get_template_directory_uri() . '/fonts/SolaimanLipi.css',false,'1.0','all');
   ...
   wp_enqueue_style('font_li_hasan_css');
   wp_enqueue_style('font_SolaimanLipi_css');
...
add_action( 'wp_enqueue_scripts', 'sharebazarnews_frontend_enque');
